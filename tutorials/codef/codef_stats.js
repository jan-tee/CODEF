...
var codef_stats = new Stats();
codef_stats.domElement.style.position = "absolute";
codef_stats.domElement.style.top = "0px";

function addstats() {
  document.body.appendChild(codef_stats.domElement);
}
