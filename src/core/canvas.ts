...
export class canvas {
  ...
  /**
          ...
          */
  public plot(x: number, y: number, width: number, color: string) {
    // save old fillstyle
  ...
  public drawTile(
    ...
    this.drawPart(
      ...
      x,
      y,
      Math.floor(nb % (this.canvas.width / this.tilew)) * this.tilew,
      Math.floor(nb / (this.canvas.width / this.tilew)) * this.tileh,
      this.tilew,
      this.tileh,
      alpha,
      rot,
  ...
  /**
          ...
          */
  public setmidhandle() {
    this.handlex = this.canvas.width / 2;
    this.handley = this.canvas.height / 2;
